...
class TNL2k(BaseVideoDataset):
    ...
    def __init__(self, root=None, image_loader=jpeg4py_loader, vid_ids=None, split=None, data_fraction=None):
        ...
        if split == 'val':
            root = '/mnt/data2/tzh/datasets/TNL2K_test_subset/'
        else:
            root = '/mnt/data2/tzh/datasets/TNL2K/'
    ...
    def _build_match(self):
        ...
        for seq_id, seq_name in enumerate(self.sequence_list):
            ...
            match_dc[seq_name] = sorted(glob.glob('{}/*'.format(seq_path)))
        return match_dc
    ...
    def get_sequence_info(self, seq_id):
        ...
        tokens_len = caption['last_hidden_state'].shape[1]
