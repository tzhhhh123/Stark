...
env_path = os.path.join('/mnt/data1/tzh/Stark/external/AR/')
...
class Tracker:
    ...
    def __init__(self, name: str, parameter_name: str, dataset_name: str, run_id: int = None, display_name: str = None,
                 result_only=False, use_ar=False):
        ...
        if use_ar:
            ...
            threshold = 0.15
            project_path = os.path.join('/mnt/data1/tzh/Stark/external/AR/')
            refine_root = os.path.join(project_path, 'ltr/checkpoints/ARcm_seg/')
    ...
    def _track_sequence(self, tracker, seq, init_info):
        ...
        for frame_num, frame_path in enumerate(seq.frames[1:], start=1):
            ...
            #     label[os.path.basename(seq.frames[frame_num - 1])].split(' ')[0])
            start_time = time.time()
